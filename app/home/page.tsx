      ...
      <div className="flex flex-col min-h-svh bg-background">
        ...
        <header className="px-5 pt-14 pb-5 bg-card border-b border-border">
          <div className="flex items-start justify-between">
            {/* Title block */}
            <div>
              <p className="text-muted-foreground text-[11px] font-semibold uppercase tracking-widest mb-1">
                2026 Midterms
              </p>
              ...
              >
                ...
                <span className="text-primary text-xs font-semibold">{activeState.name}</span>
                <ChevronRight size={10} className="text-primary/50" aria-hidden="true" />
              </Link>
            </div>

            {/* Avatar */}
            <Link href="/profile" aria-label="Your profile">
              <div className="w-11 h-11 rounded-full bg-muted border border-border flex items-center justify-center mt-1">
                {initials ? (
